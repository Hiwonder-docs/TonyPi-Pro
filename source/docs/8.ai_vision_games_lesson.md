...
For detailed feedback behavior, please refer to section [4.1.3 Program Outcome](#anchor_4_1_3) of this document.
...
The source code of this program is saved in: [/home/pi/TonyPi/Functions/Color_Warning.py](https://store.hiwonder.com.cn/docs/tonypi_pro/source_code/ai_vision/Color_Warning.zip)
...
**1.4.3 Display the Transmitted Image**
...
:::{Note}
The program defaults to recognizing the color red. To switch to blue or green, refer to "[4.2.5 Function Extension->Modify Default Recognition Color](#anchor_4_2_5)".
:::
...
The source code of this program is locate in [/home/pi/TonyPi/Functions/ColorDetect.py](https://store.hiwonder.com.cn/docs/tonypi_pro/source_code/ai_vision/ColorDetect.zip)
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to [4.2.4 Program Analysis->Import parameter module](#anchor_4_2_4).
...
(7) The default recognized color can be set as red according to the [Modify Default Recognition Color](#anchor_4_2_5) in this text.
...
- If color recognition is inaccurate, refer to the section "4. Function Extension/ 4.1 Adjusting Color Threshold" in this document to adjust the color threshold settings.
:::
...
:::{Note}
The default recognized and tracking color is green. If you want to change to blue or red, please refer to [4.4.5 Function Extension -> Modify Default Recognition Color](#anchor_4_4_5). Furthermore, when moving the handheld colored sponge blocks, the speed should not be too fast, and it should be within the range of camera recognition.
:::
...
The source code of this program is locate in [/home/pi/TonyPi/Functions/Follow.py](https://store.hiwonder.com.cn/docs/tonypi_pro/source_code/ai_vision/Follow.zip)
...
(7) The default recognized color can be set as red according to the [4.4.5 Function Extension -> Modify Default Recognition Color](#anchor_4_4_5) in this text.
...
The source code of this program is locate in [/home/pi/TonyPi/Functions/KickBall.py](https://store.hiwonder.com.cn/docs/tonypi_pro/source_code/ai_vision/KickBall.zip)
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to [4.5.4 Program Analysis->Import parameter module](#anchor_4_5_4) .
...
<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/5.1/image6.png"  style="width:100%" />
...
<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/5.1/image7.png" style="width:100%"  />
...
(7) The default recognized color can be set as red according to the [4.5.5 Function Extension -> Modify Default Recognition Color](#anchor_4_5_5) in this text.
...
:::{Note}
The program defaults to recognizing the color red. To switch to blue or green, refer to "[Modify Default Tracking Color](#anchor_4_6_5)".
:::
...
The source code of this program is locate in [/home/pi/TonyPi/Functions/VisualPatrol.py](https://store.hiwonder.com.cn/docs/tonypi_pro/source_code/ai_vision/VisualPatrol.zip)

<p id="anchor_4_6_4_1"></p>
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to "[4.6.4 Program Analysis -> Import parameter module](#anchor_4_6_4_1)".
...
<img src="../_static/media/8.ai_vision_games_lesson/6.1/image14.png" class="common_img" />
...
(7) The default tracking color can be set as black according to the "[Modify Default Tracking Color](#anchor_4_6_5)" in this text.

<img src="../_static/media/8.ai_vision_games_lesson/6.1/image7.png" class="common_img" />
...
The source code for this program is located at : [/home/pi/TonyPi/Functions/Tag_Detect.py](https://store.hiwonder.com.cn/docs/tonypi_pro/source_code/ai_vision/Tag_Detect.zip)
...
The source code of this program is locate in: [/home/pi/TonyPi/Functions/ApriltagDetect.py.](https://store.hiwonder.com.cn/docs/tonypi_pro/source_code/ai_vision/ApriltagDetect.zip)
...
**8.5.3 Program Logic and Related Code Analysis**

**(1) Import function library**

In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to "[4.8.4 Program Analysis -> Import parameter module](#anchor_4_8_4)".
...
(1)  Take the reference of "[4.8.5 Function Extension -> Modify the Action Corresponding to the Tag](#anchor_4_8_5)", enter the catalog and open the program file.
...
<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/8.1/image12.png" width="100%"  />

(3)  Then paste these 5 lines of code, and move the mouse cursor to the position shown in the figure below:

<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/8.1/image13.png" width="100%" />

(4)  Enter "**p**" on the keyboard to paste the previously copied 5 lines of code below:

<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/8.1/image14.png" width="100%" />
...
<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/8.1/image15.png" width="100%" />
...
<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/8.1/image16.png"  width="100%"/>

(8)  Check the project outcome according to the commands in previous learning.

<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/8.1/image17.png" width="100%" />

## 4.9 Face Detect

### 4.9.1 Brief Description of the Activity
...
### 4.9.2 Start and Close the Game
...
### 4.9.4 Program Brief Analysis 

The source code of the program is saved in:[/home/pi/TonyPi/Functions/Face_Detect.py ](https://store.hiwonder.com.cn/docs/tonypi_pro/source_code/ai_vision/Face_Detect.zip)
...
<p id="anchor_4_10_4"></p>

### 4.10.4 Program Analysis

The source code of this program is locate in: [/home/pi/TonyPi/Functions/FaceDetect.py](https://store.hiwonder.com.cn/docs/tonypi_pro/source_code/ai_vision/FaceDetect.zip).
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to "[4.10.4 Program Analysis -> Import parameter module](#anchor_4_10_4)".
...
### 4.10.5 Function Extension-Modify Feedback Action
