...
For detailed feedback behavior, please refer to section [4.1.3 Program Outcome](#anchor_1_3) of this document.
...
(1) Double-click <img src="../_static/media/8.ai_vision_games_lesson/1.1/image10.png"  />, and in the popup interface, click **“Execute.”**
...
:::{Note}
The program defaults to recognizing the color red. To switch to blue or green, refer to “[4.2.5 Function Extension->Modify Default Recognition Color](#anchor_2_4_1)”.
:::
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to [4.2.5 Program Analysis->Import parameter module](#anchor_2_5_3).
...
(2)  Double-click “Terminator” icon<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/2.1/image3.png"  style="width:40px" /> in the Raspberry Pi desktop and open command line.
...
:::{Note}
The default recognized and tracking color is green. If you want to change to blue or red, please refer to [4.4.5 Function Extension -> Modify Default Recognition Color](). Furthermore, when moving the handheld colored sponge blocks, the speed should not be too fast, and it should be within the range of camera recognition.
:::
...
(7) The default recognized color can be set as red according to the [4.4.5 Function Extension -> Modify Default Recognition Color](#anchor_2_4_1) in this text.
...
First, program TonyPi to recognize colors with Lab color space. You can go to “4. Expanded Course\6. OpenCV Basic Lesson” for detailed learning of Lab color space.
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to [4.5.5 Program Analysis->Import parameter module]() .
...
vim TonyPi/lab_config.yaml
  ...
  (7) The default recognized color can be set as red according to the [4.5.5 Function Extension -> Modify Default Recognition Color](#anchor_2_4_1) in this text.
...
:::{Note}
The program defaults to recognizing the color red. To switch to blue or green, refer to “6.4.1 Modify Default Tracking Color”.
:::
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to “[4.6.4 Program Analysis -> Import parameter module]()”.
...
(4) Press “i” to enter the editing 是mode, then modify black in “_target_color = ('black')” to red. If you want to recognize white, please revise to “white”.
...
<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/6.1/image14.png" class="common_img" />
...
(7) The default tracking color can be set as black according to the “4.1 Modify Default Tracking Color” in this text.

<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/6.1/image7.png" class="common_img" />
...
(2)  Click the icon <img class="common_img" src="../_static/media/8.ai_vision_games_lesson/2.1/image3.png"  style="width:40px" /> in the top left corner of the system desktop or press the shortcut "**Ctrl+Alt+T**" to open the LX terminal.
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to “[4.8.4 Program Analysis -> Import parameter module]()”.
...
(1)  Take the reference of “[4.8.5 Function Extension -> Modify the Action Corresponding to the Tag]()”, enter the catalog and open the program file.
...
(2)  Click the icon <img class="common_img" src="../_static/media/8.ai_vision_games_lesson/9.1/image2.png"  />in the top left corner of the system desktop or press the shortcut "**Ctrl+Alt+T**" to open the LX terminal.
