# 6. Intelligent Transport Course

## 6.1 Intelligent Transport
...
<img class="common_img" src="../_static/media/11.voice_intelligent_handling/3.1/image3.png"  style="width:700px" />
...
### 6.1.5 Comparison Between Voice Transport and Intelligent Transport
...
### 6.1.6 Program Parameter Instruction
...
Distinguished from the color tracking effect in "[**AI Vision Game Lesson**](https://docs.hiwonder.com/projects/TonyPi_Pro/en/latest/docs/8.ai_vision_games_lesson.html)", here is the effect of the body movement.
...
(7) The default tracking color can be set as black according to the "[**6.2.4 Function Extension -> Modify Default Recognition Color**](#anchor_6_2_4)" in this text.

### 6.2.5 Programming Instruction
