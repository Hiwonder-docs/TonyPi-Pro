...
(4) Input command "**python3 Transport.py**", then press Enter to start the game.
...
<img class="common_img" src="../_static/media/11.voice_intelligent_handling/5.1/image12.png"  class="common_img" />
...
(7) The default tracking color can be set as black according to the “[2.4.1 Modify Default Tracking Color]()” in this text.
