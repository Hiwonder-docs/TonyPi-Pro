...
(3) Enter “cd /home/pi/TonyPi/Extend/sensor_course/sensor_development/” command and press “Enter” to come to the directory of the game programmings.

```commandline
cd /home/pi/TonyPi/Extend/sensor_course/sensor_development/
```

(4) Enter “python3 face_track_and_fan.py” command, and then press “Enter” to start the game.
...
The source code of the program is located in: [/home/pi/TonyPi/Extend/sensor_course/sensor_development/face_track_and_fan.py]()
...
In this step of initialization, the first task is to import the function libraries, which will facilitate subsequent program calls. Regarding the content imported, you can refer to the [12.1.5 Working Principle -> Import Parameters Module]() for details.
...
(4) Enter command“python3 touch_color_and_mp3.py” and then press Enter to start the game.
...
The source code is located in：[/home/pi/TonyPi/Extend/sensor_course/sensor_development/touch_color_and_mp3.py]()
...
(2) Enter “vim touch_color_and_mp3.py” command and press Enter to open the game program file.
...
The source code is located in：[home/pi/TonyPi/Extend/sensor_course/sensor_development/sonar_barrier.py]()
...
During initialization, functional libraries are imported to facilitate subsequent program calls. For details on the imported content, refer to the [12.3.5 Working Principle->Importing Parameter Modules]() and their Functions section.
...
(2) Enter “vim sonar_barrier.py” command, and then press “Enter” to open the game programming file.
...
(3) Enter “python3 shape_recognition.py” command, and then press“ Enter” to start the game.
...
The source code of the program is located in: [/home/pi/TonyPi/Extend/sensor_course/sensor_development/shape_recognition.py]()
...
(2) Click the icon <img class="common_img" src="../_static/media/13.sensor_combined_practical/5.1/image4.png" style="width:50px" /> on the upper left corner of the desktop to open command line terminal. Enter “cd /home/pi/TonyPi/Extend/sensor_course/sensor_development/” command and press “ Enter” to come to the directory of the game programmings.

```commandline
cd /home/pi/TonyPi/Extend/sensor_course/sensor_development/
```

(3) Enter “python3 photo_sensor_demo.py” command, and then press “ Enter” to start the game.
...
(1) Enter “cd /home/pi/TonyPi/Extend/sensor_course/sensor_development/” command and press “ Enter” to come t  the directory of the game programmings.
...
(7) Enter command “python3  photo_sensor_demo.py” to restart the game, and observe the effect.
...
(1) Please refer to the steps (1) and (2) in "[Modify Fill Light](#anchor_5_5_1)" to enter the program editing interface, and then find the code framed in the following figure.

<img class="common_img" src="../_static/media/13.sensor_combined_practical/5.1/image13.png"  />

(2) Refer to the step (4) in "[Modify Fill Light](#anchor_5_5_1)" to modify “0.1” to “0.3” , as the figure shown below.

<img class="common_img" src="../_static/media/13.sensor_combined_practical/5.1/image14.png"  />

(3) Refer to the step (5) in "[Modify Fill Light](#anchor_5_5_1)" to save and exit. Then enter “sudo python3 PhotoSensorDemo.py” command to restart the game, and observe the demonstration effect.
...
(2) Click the icon <img src="../_static/media/13.sensor_combined_practical/6.1/image5.png"  style="width:50px" /> on the upper left corner of the desktop to open command line terminal. Enter “cd /home/pi/TonyPi/Extend/sensor_course/sensor_development/” command and press “Enter” to come to the directory of the game programmings.

```commandline
cd /home/pi/TonyPi/Extend/sensor_course/sensor_development/
```

(3) Enter “python3 mask_detect.py” command, and then press “Enter” to startthe game.
...
The source code of the program is located in: [/home/pi/TonyPi/Extend/sensor_course/sensor_development/mask_detect.py]()
...
(1) Enter  “cd /home/pi/TonyPi/Extend/sensor_course/sensor_development/”  command  and  press  “Enter”  to  come  to  the directory of the game programmings.

```commandline
cd /home/pi/TonyPi/Extend/sensor_course/sensor_development/
```

(2) Enter “vim mask_detect.py” command, and then press “Enter” to enter the program editing interface.
